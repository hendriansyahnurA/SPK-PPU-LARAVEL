...
@section('content')
    <div class="mb-4">
        <div class="card bg-primary shadow-lg">
            <div class="card-body">
                @if (Auth::check())
                    <h1 class="mr-2 d-none d-lg-inline text-white  font-weight-bold">{{ Auth::user()->name }}</h1> <span
                        class="mr-2 d-none d-lg-inline text-white  font-weight-bold">|</span>
                    <span class="mr-2 d-none d-lg-inline text-white  font-weight-bold">{{ Auth::user()->role }}</span>
                @endif
    ...
    {{-- @include('components.Dashboard.ChartData') --}}
@endsection
